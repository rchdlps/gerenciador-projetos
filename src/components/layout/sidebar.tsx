        ...
        <aside className="w-64 hidden lg:flex flex-col border-r bg-card/50 backdrop-blur-sm h-[calc(100vh-64px)] sticky top-16">
            <nav className="flex-1 p-4 space-y-6">
                ...
                <div>
                    ...
                    <div className="space-y-1">
                        <a href="/admin" className={getLinkClass(currentPath.startsWith("/admin"))}>
                            <Settings className={cn("w-4 h-4 group-hover:text-primary", currentPath.startsWith("/admin") ? "text-primary" : "text-muted-foreground")} />
